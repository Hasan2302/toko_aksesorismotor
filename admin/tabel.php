...
<body class="body">
	<nav id="nav">
						...
						<a class="link" href="tambah_admin.php">Admin</a>
...
<a href="tambahbarang.php"><input type="Button" value="Tambah"></a>
...
<?php 
		...
		<tr align="center">
			...
			<td><a href="edit.php?kode=<?php echo $data['kode'];?>"><input type="Button" value="Edit"></a>
			<a href="hapus.php?kode=<?php echo $data['kode'];?>"><input type="Button" value="Hapus"></a><hr></td>
		</tr>
<?php
}
?>
