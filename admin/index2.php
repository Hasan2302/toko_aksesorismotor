...
<form id="form l"name="form l" method=""action="">
		<table width="90%"height="" align="center" cellspcacing="1" border="0" class="tbl">
			...
			<td align="center">
					...
					<br>
					<p align="">
					<img align="" src="img/ufmVYbgS26TOkoUgR3Fg9morMUtpJA_DWO7bGLb9kBv12JLtP80SSW_ISCawZKlNtEmG6N1XZs1ka2LL1sTD8QOomyk0uysVcSqo2_ivX1HR_K0b6aHUK8JhvhGZ0dHGVNw.jpg" width="50%">
					</p>
					<br>
					<br>
					<br>
