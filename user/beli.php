...
?>
<form action="hitung_total.php" method="POST" class="frm3" enctype="multipart/form-data">
<div class="kotak-login">
        <h1 class="p-login">Beli</h1><br>
        <br>
        <hr>
        ...
        <br>
            ...
            <label>Harga</label>
            <input type="text" name="harga" class="form-login" value="<?php echo $data['harga'];?>" id="harga" placeholder="Harga .." required="" readonly="">
